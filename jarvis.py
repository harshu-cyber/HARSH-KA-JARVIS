...
def change_voice():
    ...
    # Set voice to a specific one (you can change index based on your preference)
    # Example: set the first voice (male) or second voice (female)
    voice_choice = 1  # Change to 0 for male, 1 for female (or try other indices)
